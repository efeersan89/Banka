...
public class BankSimulation {
    ...
    final static Map<Integer, Customer> customers = new HashMap<>();
    ...
    public void run() {
        ...
        do {
            System.out.println("----- BANKA İŞLEMLERİ -----");
    ...
    public void addCustomer() {
        ...
        */
        ...
        Customer customer = new Customer(customerId, firstName, lastName, city);
    ...
    public void openNewAccount(Customer customer) {
        ...
        System.out.println("Seçilen hesap türü: " + accountType);

        int customerId = customer.getCustomerId();
        int accountId = accounts.size() + 1;

        Account account = new Account(accountId, customerId, accountType);
